...
export default () => {
  ...
  return (
    <>
      <Head>
        <title>The Truth About Being a Real Estate Agent | New Agent Mindset</title>
      </Head>

      <NextSeo
        title='The Truth About Being a Real Estate Agent | New Agent Mindset'
      ...
      <div>
        ...
        <h3 className={MainStyles.title3}>#1 This Is an Easy Job</h3>
        ...
        <h3 className={MainStyles.title3}>#2 It's Just Like HGTV</h3>
        ...
        <h3 className={MainStyles.title3}>#3 My Broker Will Give Me Leads</h3>
        ...
        <h3 className={MainStyles.title3}>#4 Education Never Stops</h3>
        ...
        <h3 className={MainStyles.title3}>#5 Save money first</h3>
        ...
        <h3 className={MainStyles.title3}>#6 Mindset and Consistency</h3>
        ...
        <h3 className={MainStyles.title3}>BONUS What Others Say</h3>
        ...
        <p>To watch the video episode of this post, click the link below!</p>
