...
export default () => {
  ...
  return (
    <>
      <Head>
        <title>New Agent Mindset | Resource Hub | Buyer Information</title>
      </Head>

      <NextSeo
        title='New Agent Mindset | Resource Hub | Buyer Information'
        description='New Agent Mindset | Resource Hub | Buyer Information'
        canonical='https://newagentmindset.com/resources/buyers/info'
      />

      <div>
        <h1 className={MainStyles.title1}>buyer
         <span aria-hidden="true" className={MainStyles.title2}>&nbsp;information</span>
        </h1>
